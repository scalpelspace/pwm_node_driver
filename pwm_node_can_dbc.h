...
typedef enum {
  ...
  PWM_NODE_CAN_DBC_IDX_CURRENT_TELEMETRY = 5,
  PWM_NODE_CAN_DBC_IDX_CURRENT_ALERT = 6,
  PWM_NODE_CAN_DBC_IDX_COMMAND_CURRENT_LIMIT = 7,
  PWM_NODE_CAN_DBC_IDX_COMMAND_LOCKOUT_DURATION = 8,
  PWM_NODE_CAN_DBC_IDX_DATETIME_SET = 9,
  PWM_NODE_CAN_DBC_IDX_DATETIME_GET = 10,
  PWM_NODE_CAN_DBC_IDX_DATETIME_GET_RESPONSE = 11,
  PWM_NODE_CAN_DBC_IDX_VERSION_GET = 12,
  PWM_NODE_CAN_DBC_IDX_VERSION_GET_RESPONSE = 13,
